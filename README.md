...
| YouTube Morphe (alt) | `app.youtube.morphe` | White | [youtube-arm64-v8a-morphe-white.apk](../../releases/download/all/youtube-arm64-v8a-morphe-white.apk) |
| YouTube Music Morphe | `com.google.android.apps.youtube.music` | Default | [youtube-music-arm64-v8a-morphe.apk](../../releases/download/all/youtube-music-arm64-v8a-morphe.apk) |
